 ...
 */
package com.zero2ipo.module.entity.code;
...
public class CodeInfoEntity implements Serializable {
	...
	private String isMenu;	  //是否为菜单导航
	
	private List<CodeInfoEntity> children;
	...
	public List<CodeInfoEntity> getChildren() {
		return children;
	}
	public void setChildren(List<CodeInfoEntity> children) {

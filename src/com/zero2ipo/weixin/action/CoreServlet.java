...
import com.zero2ipo.weixin.utils.SignUtil;
...
public class CoreServlet{
	 ...
	 * 确认请求来自微信服务器
	 */
	@RequestMapping(value="/cwmwsToken",method = RequestMethod.GET)
	@ResponseBody
	 ...
	 * 处理微信服务器发来的消息
	 */
	@RequestMapping(value="/cwmwsToken",method = RequestMethod.POST)
	@ResponseBody

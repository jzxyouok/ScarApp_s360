		...
		return this.each(function(){
			...
			this.createHtml = function(){
				...
				if(para.dragDrop){
		            ...
		            html += '				<div id="status_info" class="info">选中0张共0B</div>';
		            html += '				<div class="btns">';
					html += '					<div class="webuploader_pick">选择照片</div>';
		            html += '					<div class="upload_btn">开始上传</div>';
		            html += '				</div>';
		            html += '			</div>';
					html += '				<div class="convent_choice" style="display: none">';
				    ...
				    html += '							<img class="upload_image" src="../res/upload/images/add_img.png" style="width:expression(this.width > '+imgWidth+' ? '+imgWidth+'px : this.width)" />';
				    html += '						</div>';
				    html += '					</a>';
				    html += '				</div>';
					html += '			</div>';
			...
			this.funSetStatusInfo = function(files){
				...
				// 设置内容
				$("#status_info").html("选"+num+"张共"+size);
			};
